...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Request request = new Request.Builder().url("ws:192.168.1.17:81").build();
    ...
    private void updateWaveProgressBar(int percentage) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                // Initialize the imageView if it's null
                if (imageView == null) {
                    imageView = findViewById(R.id.danger);
                    textView = findViewById(R.id.dangertext);// Make sure to use the correct ID from your layout XML.
                }

                // Check if progress is 0 and show the image
                if (finalPercentage == 0 && imageView != null) {
